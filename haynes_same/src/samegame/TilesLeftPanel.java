...
public class TilesLeftPanel extends Panel implements Runnable {
    ...
    final static int panelWidth = (18 * 3) + 10;
    final static int panelHeight = 24;

    MediaTracker media = null;

    private int tilesLeft = 200;
    ...
    public TilesLeftPanel(URL docBase, Applet app) {
	...
	int hundreds = tilesLeft / 100;
	int tens = ((tilesLeft - (hundreds * 100)) / 10);
	int ones = ((tilesLeft - (hundreds * 100)) - (tens * 10));
	...
	System.out.println("TilesLeftPanel: " + s);
    }
